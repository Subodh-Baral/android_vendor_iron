...
if __name__ == '__main__':
    # Default to iron Gerrit
    default_gerrit = 'https://review.iron-os.live'

    parser = argparse.ArgumentParser(formatter_class=argparse.RawDescriptionHelpFormatter, description=textwrap.dedent('''\
        repopick.py is a utility to simplify the process of cherry picking
        patches from iron's Gerrit instance (or any gerrit instance of your choosing)
    ...
    for change in change_numbers:
        ...
        mergables.append({
            ...
            'project': review['project'].replace("Iron-OS/", ""),
