...
ALARM_PATH := vendor/iron/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/iron/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/iron/prebuilt/common/media/audio/ringtones
